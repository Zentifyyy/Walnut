...
namespace Walnut {
	...
	void Application::UI_DrawTitlebar(float& outTitlebarHeight)
	{
		...
		// Logo
		{
			const int logoWidth = m_Specification.LogoSize.x;// m_LogoTex->GetWidth();
			const int logoHeight = m_Specification.LogoSize.y;// m_LogoTex->GetHeight();
